  ...
  return (
    <main className="min-h-screen">
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-spa-gold-500 via-spa-gold-600 to-spa-sage-700" />
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute top-1/3 -right-32 w-96 h-96 bg-spa-sage-400/20 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }} />
          <div className="absolute -bottom-20 left-1/4 w-72 h-72 bg-spa-gold-300/15 rounded-full blur-3xl animate-float" style={{ animationDelay: '4s' }} />

          {/* Small floating particles */}
          <div className="hidden md:block absolute top-20 left-[15%] w-3 h-3 bg-white/30 rounded-full animate-float" />
          <div className="hidden md:block absolute top-40 right-[20%] w-2 h-2 bg-white/40 rounded-full animate-float" style={{ animationDelay: '1s' }} />
          <div className="hidden md:block absolute bottom-32 left-[30%] w-4 h-4 bg-white/20 rounded-full animate-float" style={{ animationDelay: '3s' }} />
          <div className="hidden md:block absolute top-1/2 right-[10%] w-2 h-2 bg-spa-gold-200/40 rounded-full animate-float" style={{ animationDelay: '2.5s' }} />
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 relative z-10 text-center">
          {/* Badge */}
          <div
            className={`inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white/20 backdrop-blur-sm text-white text-sm font-bold mb-8 border border-white/30 transition-all duration-700 ${corporateInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
          >
          ...
          {/* Headline */}
          <h2
            className={`text-5xl md:text-6xl lg:text-7xl font-display font-bold text-white mb-6 drop-shadow-lg transition-all duration-700 delay-100 ${corporateInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
          >
          ...
          {/* Short Subtext */}
          <p
            className={`text-xl md:text-2xl text-white/90 mb-16 max-w-2xl mx-auto font-light transition-all duration-700 delay-200 ${corporateInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
          >
          ...
          >
            ...
            <div className="flex flex-col items-center gap-3">
              <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-white/20 backdrop-blur-sm flex items-center justify-center border border-white/30 transition-transform duration-300 hover:scale-110">
                <BuildingOffice2Icon className="h-7 w-7 sm:h-8 sm:w-8 text-white" />
              </div>
              <span className="text-white/90 font-medium text-xs sm:text-sm">We Come to You</span>
            </div>
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              <span className="text-white/90 font-medium text-xs sm:text-sm">Any Team Size</span>
            </div>
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              <span className="text-white/90 font-medium text-xs sm:text-sm">Flexible Scheduling</span>
            </div>
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              <span className="text-white/90 font-medium text-xs sm:text-sm">Custom Packages</span>
            </div>
          </div>
          ...
          >
            <PhoneLink
              ...
              className="inline-flex items-center gap-3 sm:gap-4 px-8 sm:px-12 py-5 sm:py-6 bg-white hover:bg-spa-cream-50 text-spa-sage-800 rounded-full font-bold text-lg sm:text-xl transition-all duration-300 shadow-2xl hover:shadow-[0_25px_50px_rgba(0,0,0,0.25)] transform hover:-translate-y-1 group"
            >
              <PhoneIcon className="h-6 w-6 sm:h-7 sm:w-7 text-spa-gold-600 group-hover:animate-pulse" />
