...
export default function Header() {
  ...
  return (
    ...
    >
      <nav className="grid grid-cols-2 lg:grid-cols-3 items-center max-w-5xl mx-auto px-2">
        ...
        <div className="hidden lg:flex justify-self-end">
          <Link href="/book">
            <div className="group relative overflow-hidden bg-transparent hover:bg-custom-gold/10 text-custom-gold px-8 py-4 rounded-full font-bold text-base transition-all duration-500 shadow-2xl hover:shadow-custom-gold/30 transform hover:scale-105 border-2 border-custom-gold hover:border-custom-gold backdrop-blur-sm">
      ...
      >
        <div 
          className={`fixed inset-0 z-50 w-full h-full overflow-y-auto bg-white px-6 py-6 transition-transform duration-300 ${
        ...
        >
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gold-200">
              ...
              <div className="py-6">
                <Link href="/book">
                  <div className="w-full bg-gold-500 hover:bg-gold-600 text-black px-6 py-4 rounded-full font-bold text-center transition-all duration-300 hover:shadow-xl hover:shadow-gold/30 border-2 border-gold-400 hover:border-gold-300">
                    <span>
                      Book Now
                    </span>
                  </div>
