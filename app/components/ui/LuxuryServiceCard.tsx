        ...
        <div className={`relative z-10 p-8 h-full flex flex-col transition-transform duration-700 ${
          ...
          <div className="grid grid-cols-2 gap-3 transition-all duration-300">
            <Button 
              variant="outline" 
              size="sm" 
              className="bg-white/80 backdrop-blur-sm border-spa-sage-300 text-spa-sage-800 hover:bg-spa-sage-100 hover:border-spa-sage-400 hover:text-spa-sage-900 transition-all duration-300 font-medium"
              onClick={() => {
            ...
            <Button 
              variant="luxury" 
              size="sm" 
              className="bg-spa-gold-700 hover:bg-spa-gold-800 text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-300 group/btn border border-spa-gold-800"
              onClick={onBookNow}
            >
              Book Now
