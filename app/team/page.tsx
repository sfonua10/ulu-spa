...
import { founders } from '@/app/data/about';
import {
  SparklesIcon,
  UserGroupIcon
  ...
  return (
    <div className="relative">
      ...
      >
        <section
          ref={heroRef}
          className="min-h-[60vh] flex items-center justify-center relative z-10 pt-24"
        >
          <div className={`max-w-4xl mx-auto text-center px-6 transition-all duration-1000 ${
            ...
            <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-white/10 backdrop-blur-md border border-white/20 mb-8 animate-in animate-fade-in animate-slow">
              <UserGroupIcon className="w-5 h-5 text-spa-gold-400" />
              <span className="text-white font-medium tracking-wide">Our Team</span>
              <UserGroupIcon className="w-5 h-5 text-spa-gold-400" />
            </div>
            ...
            <p className="text-lg md:text-xl text-white/90 max-w-2xl mx-auto leading-relaxed animate-in animate-fade-in animate-delay-500">
              The passionate individuals behind ULU Head Spa, committed to bringing you
              transformative wellness experiences rooted in Polynesian tradition
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className={`text-center mb-16 transition-all duration-1000 ${
            ...
            <p className="text-xl text-stone-600 max-w-2xl mx-auto">
              The visionaries who brought ULU Head Spa to life, combining cultural heritage
